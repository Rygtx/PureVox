...
# Same recipe as build_lite_local.ps1; extra: websockets/av/cryptography/zeroconf/qrcode + html page.
# Usage: powershell -ExecutionPolicy Bypass -File build_net_local.ps1
