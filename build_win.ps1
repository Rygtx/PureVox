...
# Prefer the bundled Python 3.13 (generated by bootstrap_python313.ps1 in packages\python313w)
# so the build is independent of the system Python. Fall back to python on PATH.
$embeddedPy = Join-Path (Split-Path -Parent $MyInvocation.MyCommand.Path) "packages\python313w\python.exe"
